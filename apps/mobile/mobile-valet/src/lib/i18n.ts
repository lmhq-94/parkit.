...
const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "auth.login.failed": "Correo o contraseña incorrectos.",
    "auth.signup.failed": "Error al registrarse. Por favor, intenta nuevamente.",
    "auth.signup.emailExists": "El correo electrónico ya está registrado.",
    "auth.forgotPassword.failed": "Error al enviar el enlace de recuperación. Por favor, intenta nuevamente.",
    "auth.errorGeneric": "Ha ocurrido un error. Por favor, intenta nuevamente.",
"auth.email.placeholder": "usuario@email.com",
"auth.password.placeholder": "••••••••",
    "tickets.settings": "Ajustes",
    "tickets.logout": "Salir",
    ...
    "tickets.loading": "Cargando tu lista…",
    ...
    "tickets.subtitleDriver": "Vehículos asignados para conducir o entregar. Desliza para actualizar.",
    "tickets.subtitleDriverParking": "Solicitudes de ingreso en tu cola de trabajo.",
    "tickets.subtitleDriverDelivery": "Devoluciones que necesitas completar.",
    "tickets.emptyDriver": "Nada asignado aún",
    "tickets.emptyHintDriver": "Cuando un recepcionista te asigne un vehículo, aparecerá aquí.",
    "tickets.titleReception": "Recepción",
    "tickets.subtitleReception": "Recibe y verifica vehículos. Márcalos como parqueados al finalizar.",
    "tickets.emptyReception": "Sin vehículos en cola",
    "tickets.emptyHintReception": "Los vehículos asignados como recepción aparecerán aquí.",
    "tickets.roleHintDriver": "Solo ves lo que te asignan para conducir.",
    "tickets.roleHintReception": "Modo recepción: verifica y coordina devoluciones de vehículos.",
    "tickets.summaryTotal": "En cola",
    "tickets.summaryRequested": "Solicitado",
    "tickets.summaryParked": "Parqueado",
    "tickets.home": "Inicio",
    ...
    "profile.tapToChangePhoto": "Toca para cambiar la foto",
    ...
    "help.title": "Ayuda",
    "receive.title": "Datos del conductor",
    ...
    "receive.qrPremiumKicker": "Huésped con reserva",
    "receive.qrPremiumTitle": "Escanear QR de reserva",
    "receive.qrPremiumSubtitle":
      "Apunta la cámara al QR de reserva del huésped; la validación ocurre automáticamente.",
    ...
    "receive.labelPlate": "Matrícula",
    "receive.labelFullName": "Nombre completo",
    "receive.labelEmail": "Correo Electrónico",
    "receive.labelPhoneOptional": "Teléfono (Opcional)",
    "receive.labelDriver": "Conductor",
    "receive.labelVehicle": "Vehículo",
    "receive.labelBrand": "Marca",
    "receive.labelModel": "Modelo",
    "receive.labelColor": "Color",
    "receive.labelYear": "Año",
    ...
    "receive.wizardVehicleHelp": "Ingresa los datos del vehículo",
    "receive.wizardTicketTitle": "Tiquete",
    ...
    "receive.wizardDamageTitle": "Evidencias",
    ...
    "receive.damagePlaceholderText":
      "Toca para agregar fotos",
    "receive.damageContinueA11y": "Siguiente: asignar conductor valet",
    "receive.qrGenerateError": "Error al generar el código QR",
    ...
    "receive.placeholderBrand": "Marca del vehículo",
    "receive.placeholderModel": "Modelo del vehículo",
    "receive.placeholderColor": "Color del vehículo",
    "receive.placeholderYear": "Año del vehículo",
    ...
    "receive.typeCardTitle": "Tarjeta",
    "receive.typeCardBody": "Cliente con tarjeta vinculada para beneficios",
    "receive.typeDirectTitle": "Pago directo",
    "receive.typeDirectBody": "Cliente paga el servicio sin tarjeta",
    "receive.typeReservationTitle": "Reserva",
    "receive.typeReservationBody": "Cliente con código de reserva activo",
    "receive.cardScannerTitle": "Escanear tarjeta",
    "receive.cardScannerSubtitle": "Apunta la cámara a la tarjeta del cliente",
    "receive.cardHolderPlaceholder": "NOMBRE APELLIDO",
    "receive.cardExpiresLabel": "Vence",
    "receive.scanCardTitle": "Escanear tarjeta",
    "receive.scanCardSubtitle": "Apunta la cámara a la tarjeta del cliente",
    ...
    "receive.scanCardButton": "Escanear tarjeta",
    "receive.scanningCard": "Escaneando...",
    "receive.cardScannedSuccess": "Tarjeta escaneada exitosamente",
    "receive.cameraPermissionNeeded": "Se necesita acceso a la cámara para escanear la tarjeta",
    "receive.cardVerifyOnHoldTitle": "Verificación Premium",
    "receive.cardVerifyOnHoldBody": "Verifica en segundos que el método de pago está activo con una experiencia segura de Stripe. Este paso es requerido para completar el registro.",
    "receive.cardVerifyBadge": "Requerido",
    "receive.cardVerifyStarted": "Stripe abierto para verificación de tarjeta.",
    "receive.cardVerifyStartedHint": "Stripe está abierto para completar la verificación segura. Vuelve cuando termines para continuar con el registro.",
    "receive.cardVerifyOptionalHint": "Requerido para una recepción eficiente. Sigue las instrucciones de Stripe para verificar la tarjeta.",
    ...
    "returnPickup.emptyTitle": "No hay vehículos",
  ...
  en: {
    ...
    "auth.signup.emailExists": "The email address is already registered.",
    "auth.forgotPassword.failed": "Failed to send recovery link. Please try again.",
    "auth.errorGeneric": "An error occurred. Please try again.",
"auth.email.placeholder": "user@email.com",
"auth.password.placeholder": "••••••••",
    ...
    "receive.wizardPlateHelp":
      "Enter the vehicle license plate",
    "receive.labelPlate": "License plate",
    "receive.labelFullName": "Full name",
    "receive.labelEmail": "Email",
    "receive.labelPhoneOptional": "Phone (Optional)",
    "receive.labelDriver": "Driver",
    "receive.labelVehicle": "Vehicle",
    "receive.labelBrand": "Brand",
    "receive.labelModel": "Model",
    "receive.labelColor": "Color",
    "receive.labelYear": "Year",
    ...
    "receive.wizardVehicleHelp": "Enter the vehicle details",
    "receive.wizardTicketTitle": "Ticket",
    "receive.wizardTicketHelp":
    ...
    "receive.wizardDamageTitle": "Evidence",
    ...
    "receive.damagePlaceholderText": "Tap to add photos",
    "receive.damageContinueA11y": "Next: assign valet driver",
    "receive.qrGenerateError": "Error generating QR code",
    ...
    "receive.placeholderBrand": "Vehicle brand",
    "receive.placeholderModel": "Vehicle model",
    "receive.placeholderColor": "Vehicle color",
    "receive.placeholderYear": "Vehicle year",
    ...
    "receive.typeCardTitle": "Card",
    "receive.typeCardBody": "Customer with linked card for benefits",
    "receive.typeDirectTitle": "Direct payment",
    "receive.typeDirectBody": "Customer pays service without card",
    "receive.typeReservationTitle": "Reservation",
    "receive.typeReservationBody": "Customer with active reservation code",
    ...
    "returnPickup.emptyTitle": "No vehicles",
