...
const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "park.next": "Siguiente",
    "park.confirmTitle": "¿Ya estás en el parqueo?",
    "park.confirmMessage": "Confirma el espacio donde quedará el vehículo para continuar.",
  ...
  en: {
    ...
    "park.next": "Next",
    "park.confirmTitle": "Are you at the parking lot?",
    "park.confirmMessage": "Confirm the slot where the vehicle will be parked.",
