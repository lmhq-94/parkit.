...
const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "receive.stepReservationQr": "2. Reserva (QR)",
    "receive.reservationQrHelp":
      "Apunta la cámara al QR del cliente o introduce el ID de la reserva abajo.",
    ...
    "receive.parkingSectionStep3": "3. Parqueo",
    "receive.stepPlateReservation": "4. Matrícula",
    ...
    "receive.wizardQrHelp":
      "Escanea el código QR o escribe el ID de la reserva y pulsa Validar antes de continuar.",
    ...
    "receive.wizardTicketHelp":
      "Entrega o explica al cliente los códigos o instrucciones del tiquete antes de asignar parqueo.",
    ...
    "receive.wizardParkingHelp":
      "Por defecto usamos el parqueo más cercano a tu ubicación. Puedes elegir otro en la lista; la empresa del ingreso será la de ese parqueo.",
  ...
  en: {
    ...
    "receive.stepReservationQr": "2. Booking (QR)",
    "receive.reservationQrHelp":
      "Point the camera at the guest’s QR or enter the booking ID below.",
    ...
    "receive.parkingSectionStep3": "3. Parking",
    "receive.stepPlateReservation": "4. License plate",
    ...
    "receive.wizardQrHelp":
      "Scan the QR code or enter the booking ID and tap Validate before continuing.",
    "receive.wizardQrNoCompany":
    ...
    "receive.wizardTicketHelp":
      "Give or explain the ticket codes or instructions to the customer before assigning parking.",
    "receive.wizardTicketAck": "I have given or explained the ticket codes to the customer",
    "receive.wizardParkingTitle": "Parking",
    "receive.wizardParkingHelp":
      "By default we use the parking closest to you. You can pick another from the list; check-in will use that parking’s company.",
