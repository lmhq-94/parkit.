  ...
  <head>
    ...
    <style>
      ...
      @media only screen and (max-width: 480px) {
        ...
        .ticket-card { padding: 28px 24px !important; }
        .ticket-code { font-size: 28px !important; }
      }
    </style>
  </head>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td style="padding-bottom: 24px;">
                      <h2 style="font-size: 22px; font-weight: 600; margin: 0; color: #0f172a; letter-spacing: -0.01em; line-height: 1.3;">Tu vehículo está seguro</h2>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding-bottom: 32px;">
                      <p style="font-size: 15px; line-height: 1.6; color: #475569; margin: 0;">
                        Hemos recibido tu vehículo en <strong style="color: #0f172a; font-weight: 600;">${locationDisplay || "nuestra ubicación"}</strong>. Guarda este comprobante para retirar tu vehículo.
                      </p>
                    </td>
                  </tr>
                  <tr>
                        ...
                        <tr>
                          <td style="position: relative;">
                            ...
                            <div style="text-align: center; border-bottom: 2px dashed #cbd5e1; padding-bottom: 20px; margin-bottom: 25px;">
                              ...
                              <h3 style="margin: 8px 0 0; font-size: 18px; font-weight: 800; color: #000000; font-family: 'JetBrains Mono', monospace;">VALET PARKING</h3>
                            </div>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="font-family: 'Courier New', Courier, monospace; font-size: 12px; color: #1a202c; margin-bottom: 25px;">
                              <tr>
                              ...
                              <tr>
                                <td style="padding: 8px 0; text-align: left;">INGRESO:</td>
                                <td style="padding: 8px 0; text-align: right; font-weight: bold;">${entryTime || "—"}</td>
                              </tr>
                            </table>
