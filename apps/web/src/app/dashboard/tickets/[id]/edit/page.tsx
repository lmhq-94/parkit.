  ...
  return (
    <div className="flex-1 flex flex-col pt-6 px-4 md:px-10 lg:px-12 w-full gap-5">
      ...
      <div
        ...
        className="flex-1 flex flex-col overflow-y-auto overflow-x-hidden min-h-0 pb-24"
      >
      ...
      <header
        className={`shrink-0 fixed bottom-0 left-0 right-0 z-10 flex flex-col bg-page border-t border-card-border transition-all duration-200 ${
          footerShadow 
            ? "pt-3 md:pt-5 pb-4 shadow-[0_-1px_3px_0_rgba(0,0,0,0.06),0_-1px_2px_-1px_rgba(0,0,0,0.06)] dark:shadow-[0_-1px_3px_0_rgba(0,0,0,0.2),0_-1px_2px_-1px_rgba(0,0,0,0.15)]" 
            : "pt-3 md:pt-5 pb-4"
        }`}
      >
