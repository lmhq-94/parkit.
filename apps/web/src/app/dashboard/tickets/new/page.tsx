...
export default function NewTicketPage() {
  ...
  return (
    <div className="flex-1 flex flex-col pt-6 pb-8 px-4 md:px-10 lg:px-12 max-w-[1600px] mx-auto w-full gap-5">
      ...
      {/* Info box */}
      <div className="flex items-start gap-3 px-5 py-4 rounded-2xl bg-rose-500/5 border border-rose-500/15">
        <Ticket className="w-4 h-4 text-rose-400 shrink-0 mt-0.5" />
        <div>
          <p className="text-sm font-medium text-text-primary">{t("tickets.entryTicket")}</p>
