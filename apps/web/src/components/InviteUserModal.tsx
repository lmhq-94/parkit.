            ...
            <div className="flex gap-2">
              <div className="relative flex-1 group">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-lg border border-input-border bg-input-bg text-text-primary text-sm focus:border-company-primary focus:outline-none focus:ring-1 focus:ring-company-primary transition-colors"
                />
              </div>
              <button
                type="button"
