/**
 * Phone number handling and country dialing codes.
...
/** Empty = valid (optional). If has digits, E.164 10–15 digits (like web). */
...
/** For API: just digits or undefined if empty (like web profile). */
